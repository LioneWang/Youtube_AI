    ...
    for item in test_data:
        ...
        with torch.no_grad():
            ...
            try:
                ...
                video_id, start_time, end_time = "unknown", 0.0, 0.0  # 设置默认值或其他处理方式
...
def main():
    test_data_path = 'test.json'  # 修改为您的测试数据文件路径
    model_dir = './trained_model/checkpoint-15663'
    tokenizer_name = 'bert-base-uncased'

    label_encoder = load_label_encoder('./trained_model/combined_to_label.pkl')  # 加载之前保存的标签编码器文件
